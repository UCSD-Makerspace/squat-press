...
MAX_CM_PER_S = 1
MAX_STEPS_PER_MS = MAX_CM_PER_S * STEPS_PER_2_5CM / 2.5 / 1000
    ...
    try:
        while True:
            if current_direction == tmc2209.Direction.COUNTERCLOCKWISE:
                current_direction = tmc2209.Direction.CLOCKWISE
                motor.step_ramped(steps=STEPS_PER_2_5CM, max_steps_per_ms=MAX_STEPS_PER_MS, accel_steps_per_ms=0.5, decel_steps_per_ms=0.5)
            else:
                current_direction = tmc2209.Direction.COUNTERCLOCKWISE
                motor.step_ramped(steps=STEPS_PER_2_5CM, max_steps_per_ms=MAX_STEPS_PER_MS, accel_steps_per_ms=1, decel_steps_per_ms=0.5)
